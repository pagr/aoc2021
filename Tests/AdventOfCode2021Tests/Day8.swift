...
final class Day8Tests: XCTestCase {
    func testExample() throws {
        ...
        XCTAssertEqual(d.findAllKnownDigits(d: data[0]), 5353)
    }
    ...
    func testExample2() {
        ...
        """
            ...
            let data = d.parse(input: input)
            XCTAssertEqual(d.findKnownDigits(d: data), 26)

            XCTAssertEqual(d.findAllKnownDigits(d: data[0]), 8394)
        XCTAssertEqual(d.findAllKnownDigits(d: data[1]), 9781)
        XCTAssertEqual(d.findAllKnownDigits(d: data[2]), 1197)
        XCTAssertEqual(d.findAllKnownDigits(d: data[3]), 9361)
        XCTAssertEqual(d.findAllKnownDigits(d: data[4]), 4873)
        XCTAssertEqual(d.findAllKnownDigits(d: data[5]), 8418)
        XCTAssertEqual(d.findAllKnownDigits(d: data[6]), 4548)
        XCTAssertEqual(d.findAllKnownDigits(d: data[7]), 1625)
        XCTAssertEqual(d.findAllKnownDigits(d: data[8]), 8717)
        XCTAssertEqual(d.findAllKnownDigits(d: data[9]), 4315)
    }
    ...
    func testReal() {
        ...
        """
            ...
            let data = d.parse(input: input)
            XCTAssertEqual(d.findKnownDigits(d: data), 303)
        XCTAssertEqual(d.findAllKnownDigits(d: data), 961734)
    }
}
