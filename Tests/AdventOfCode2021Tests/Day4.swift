...
final class Day4Tests: XCTestCase {
    func testExample() throws {
        ...
        XCTAssertEqual(d.bingoFirst(data: data), 4512)
        XCTAssertEqual(d.bingoLast(data: data), 1924)
    }
    ...
    func testReal() throws {
        ...
        let d = Day4()
        let data = d.parse(input: input)
        XCTAssertEqual(d.bingoFirst(data: data), 87456)
        XCTAssertEqual(d.bingoLast(data: data), 15561)
    }
}
